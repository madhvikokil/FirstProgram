...
function CheckTheSelectOption(){
 
  if(document.getElementById("categorylist").value == "category"){
    document.getElementById("category11").style.display="inline-block";
  }

  if(document.getElementById("categorylist").value == "status"){
    document.getElementById("category12").style.display="inline-block";
  }
}

function SearchByCategory(){

  var option = document.getElementById("category11").value;
  var userArray = mainData();
  var filteringthearray = new Array();

 if(document.getElementById("category11").value=== option) {
      filteringthearray=userArray.filter(function(category1){
      return(category1.category===option);
      })
...
function SearchByStatus(){
  ...
  var option = document.getElementById("category12").value;

 if(document.getElementById("category12").value === option){
    filteringthearray=userArray.filter(function(category1){
      return(category1.isdone === option);
    })
